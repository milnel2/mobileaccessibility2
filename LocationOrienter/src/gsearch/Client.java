...
//			System.out.println(url);
	...
	public List<Result> searchLocal(double lat, double lon, String query, int page)
	{
		Map<String, String> params = new LinkedHashMap<String, String>();
		
		params.put("sll", lat + "," + lon);
		params.put("mrt", "localonly");
		params.put("sspn", "0.003,0.003");
		params.put("rsz", "large");
		params.put("start", ""+(page*8));
		params.put("key", "ABQIAAAAOYOKNiXgC9O-F56Bezr5kBSpx66uwWsBvMn9L-5OxoDGGlXOwBSEs7j4CjuN4KvOS9m1sRtM7yxPEA");
