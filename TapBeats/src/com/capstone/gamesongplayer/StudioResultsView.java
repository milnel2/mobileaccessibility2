...
public class StudioResultsView extends MenuView {
     ...
     */
    public StudioResultsView(String songname, int n, Context context, int width, int height, OptionalTextToSpeech m, MediaPlayer player, Intent iBack, String sName)  
    {  
