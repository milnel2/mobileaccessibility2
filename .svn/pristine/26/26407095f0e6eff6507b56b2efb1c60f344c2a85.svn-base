...
public class StudioBrowse extends Screen {
    ...
    private MediaPlayer mpsong = null; // for playing back song
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Set menu
        StudioBrowseView view = new StudioBrowseView(this, screenWidth, screenHeight, tts, mpsong, mpname, intentBack);
        setContentView(view); 
