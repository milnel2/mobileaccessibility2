...
public class FileLog {
	...
	private volatile ArrayList<String> mPostMsg;
	...
	{
		Log.v(TAG, "stopHttpPostThread()");
		mSentInterrupt = true;
		mPoster.interrupt();
	} 
	
	// Called by the HttpPost thread and in the onPause() method of FileLog
