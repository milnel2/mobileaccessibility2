...
@protocol ZXingDelegate
- (BOOL)zxingController:(ZXingWidgetController*)controller shouldScanBitmap:(uint8_t *)bitmap width:(size_t)width height:(size_t)height blobMinX:(short *)minx blobMaxX:(short *)maxx blobMinY:(short *)miny blobMaxY:(short *)maxy;
