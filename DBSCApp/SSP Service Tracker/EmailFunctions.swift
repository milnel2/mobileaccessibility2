...
public class EmailFunctions {
    ...
    class func sendEmail(sendTo:String, content:String, resent:Bool = false) -> Bool {
        
        var subject = EmailFunctions.formatSubject(storedEmail!, resent: resent)
        
        var mailgun = Mailgun.clientWithDomain("sandbox0e7944bd3713463490dbc1deb854a4a4.mailgun.org", apiKey: "key-564c3265fb68447bd58a528a669ea736")
        mailgun.sendMessageTo(sendTo, from: "dbscemailer@gmail.com", subject: subject, body: content)
    ...
    class func formatSubject(email:NSManagedObject, resent:Bool = false) -> String {
